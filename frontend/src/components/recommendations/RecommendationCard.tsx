    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
      <div className="flex justify-between items-start mb-3">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">{recommendation.sector}</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-2 pt-3 border-t border-gray-100 dark:border-gray-700">
        <div className="text-center">
          ...
          <div className="font-medium text-gray-900 dark:text-white">{recommendation.key_metrics.per}</div>
        </div>
        <div className="text-center">
          <div className="text-xs text-gray-500">PBR</div>
          <div className="font-medium text-gray-900 dark:text-white">{recommendation.key_metrics.pbr}</div>
        </div>
        <div className="text-center">
          <div className="text-xs text-gray-500">Div. Yield</div>
          <div className="font-medium text-gray-900 dark:text-white">{recommendation.key_metrics.dividend_yield}%</div>
        </div>
      </div>
    </div>
  );
