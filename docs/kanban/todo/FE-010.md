...
│  Compare Stocks                                              │
│  ┌─────────────────────────────────────────────────────┐   │
│  │ [Search stock...]              [Compare up to 5]    │   │
│  └─────────────────────────────────────────────────────┘   │
│  ┌──────────┬──────────┬──────────┬──────────┬──────────┐  │
│  │ 005930   │ 000660   │ 035420   │ 051910   │ [+ Add]  │  │
│  │ Samsung  │SK Hynix  │ NAVER    │LG Chem   │          │  │
│  │ [×]      │ [×]      │ [×]      │ [×]      │          │  │
│  └──────────┴──────────┴──────────┴──────────┴──────────┘  │
└─────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────┐
│  Comparison Table                    [Table View | Charts]   │
│  ┌────────────────┬─────────┬─────────┬─────────┬─────────┐│
│  │ Metric         │Samsung  │SK Hynix │ NAVER   │LG Chem  ││
│  ├────────────────┼─────────┼─────────┼─────────┼─────────┤│
│  │ Current Price  │ ₩75,000 │₩125,000 │₩220,000 │₩430,000 ││
│  │ Market Cap     │ 500T    │ 90T     │ 35T     │ 75T     ││
│  │ P/E Ratio      │ 12.5    │ 8.3     │ 28.4    │ 15.2    ││
│  │ P/B Ratio      │ 1.2     │ 1.5     │ 3.8     │ 1.8     ││
│  │ ROE (%)        │ 9.8     │ 18.2    │ 13.5    │ 12.1    ││
│  │ Revenue Growth │ 5.2%    │ 12.5%   │ 18.3%   │ 8.7%    ││
│  │ Debt Ratio     │ 25%     │ 35%     │ 15%     │ 42%     ││
│  │ Dividend Yield │ 2.1%    │ 1.8%    │ 0.5%    │ 1.2%    ││
│  │ Beta           │ 1.1     │ 1.3     │ 1.2     │ 1.0     ││
│  │ RSI (14)       │ 55      │ 68      │ 42      │ 51      ││
│  │ ...            │         │         │         │         ││
│  └────────────────┴─────────┴─────────┴─────────┴─────────┘│
│  Highlight: 🟢 Best | 🟡 Average | 🔴 Worst (per metric)    │
└─────────────────────────────────────────────────────────────┘
```
...
┌─────────────────────────────────────────────────────────────┐
│  Chart View                                                  │
│  [Fundamentals | Valuation | Technical | Performance]       │
│                                                              │
│  ┌──────────────────────────────────────────────────────┐  │
│  │         Valuation Metrics - Radar Chart              │  │
│  │                                                       │  │
│  │                    P/E Ratio                          │  │
│  │                       /\                              │  │
│  │                      /  \                             │  │
...
│  │         Debt Ratio ──────── Growth                   │  │
│  │                                                       │  │
│  │  Legend: ● Samsung ● SK Hynix ● NAVER ● LG Chem     │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                              │
│  ┌──────────────────────────────────────────────────────┐  │
│  │         Price Performance - Line Chart (1Y)          │  │
│  │  [1M | 3M | 6M | 1Y | 3Y]                            │  │
│  │                                                       │  │
...
### Phase 1: Stock Selection Component (3 hours) ✅ COMPLETE
...
### Phase 2: Comparison Table (4 hours) ✅ COMPLETE
...
### Phase 3: Chart Visualizations (5 hours) ✅ COMPLETE
...
### Phase 4: Data Fetching & State (2 hours) ✅ MOSTLY COMPLETE (covered in Phase 1-2)
...
### Phase 5: Export & Sharing (1 hour) ✅ MOSTLY COMPLETE (covered in Phase 2)
...
### Phase 6: Testing & Polish (2 hours) ✅ COMPLETE
...
```
src/pages/
└── StockComparisonPage.tsx           # Main comparison page

src/components/comparison/
├── StockSelector.tsx                 # Stock search and selection
├── StockChip.tsx                     # Individual stock chip
├── ComparisonTable.tsx               # Table view
├── ComparisonCharts.tsx              # Chart views container
├── RadarChartView.tsx                # Radar chart for metrics
├── BarChartView.tsx                  # Bar chart comparison
├── PerformanceChart.tsx              # Price performance line chart
├── MetricTooltip.tsx                 # Metric definition tooltips
├── ExportButton.tsx                  # Export functionality
└── __tests__/
    └── comparison.test.tsx           # Component tests
```

### New Hooks
```typescript
src/hooks/
├── useStockComparison.ts             # Main comparison logic
├── useComparisonData.ts              # Fetch multiple stocks
└── useComparisonCharts.ts            # Chart data formatting
```
...
## Progress
- **95%** - Phases 1-6 Complete (Stock Selection, Table, Charts, Data Fetching, Export/Sharing, Testing)
- **Remaining**: Manual testing (mobile responsiveness, accessibility audit, performance optimization)
