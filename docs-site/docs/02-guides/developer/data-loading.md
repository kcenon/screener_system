...
description: How to load sample stock data for development and testing
...
:::tip Data Quality
All checks should return 0 issues. If you see any issues, regenerate the seed data.
:::
...
This seed data is for **testing and development only**.
:::
...
See [Data Pipeline Architecture](../../04-architecture/data-pipeline.md) for production data setup.
